...
var routes = [{
  ...
  children: [{
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require('../views/Index0.vue'));
      });
    }
  }, {
    path: '/my',
  ...
  component: function component() {
    return Promise.resolve().then(function () {
      return _interopRequireWildcard(require('../views/Info.vue'));
    });
  }
}, {
  path: '/sign',
  ...
  component: function component() {
    return Promise.resolve().then(function () {
      return _interopRequireWildcard(require('../views/sign.vue'));
    });
  }
}, {
  path: '/login',
